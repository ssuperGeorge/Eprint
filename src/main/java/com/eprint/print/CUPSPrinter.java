...
import com.eprint.print.IPPPrintService;
import com.eprint.print.CustomMediaSizeName;
import com.eprint.print.CustomMediaTray;
...
public class CUPSPrinter  {
    ...
    private static native boolean tmp();
...
//    private static boolean libFound;
    private static final String cupsServer = "localhost";
        ...
        try {
            ...
            if (urlConnection != null) {
                ...
                if (IPPPrintService.writeIPPRequest(os,
                    ...
                    HashMap<String, AttributeClass>[] responseMap = IPPPrintService.readIPPResponse(is);
                    is.close();
